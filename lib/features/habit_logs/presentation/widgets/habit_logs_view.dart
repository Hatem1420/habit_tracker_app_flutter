...
class HabitLogsView extends StatelessWidget {
  ...
  const HabitLogsView({super.key, required this.habitId});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(centerTitle: true, title: const Text('Habit Logs')),
      body: BlocBuilder<HabitLogsCubit, HabitLogsState>(
        builder: (context, state) {
          ...
          if (state is HabitLogsSuccess) {
            ...
            }).toList()..sort((a, b) => b.logDate.compareTo(a.logDate));
