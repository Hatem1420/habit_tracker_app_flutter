      ...
      body: BlocBuilder<HabitLogsCubit, HabitLogsState>(
        builder: (context, state) {
          ...
          if (state is HabitLogsSuccess) {
            final habit = state.logs.firstWhere(
              (e) => e.id.toString() == habitId,
            );
            ...
            final todayLogs = habit.habitLogs
                .where((log) => _parseOnlyDate(log.logDate.toString()) == today)
                .toList();
            final previousLogs =
                habit.habitLogs
                    .where(
                          ...
                          children: [
                            ...
                            HabitLogsSection(
                              ...
                              onCompleteHabit: () async {
                                ...
                                if (confirm == true) {
                                  context.read<HabitLogsCubit>().addHabitLog(
                                    habitId,
                                  );
                                }
                              },
